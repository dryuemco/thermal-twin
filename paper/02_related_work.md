...
across Europe, testing generalisation by pooled fitting with per-site evaluation. What has not been
tested is whether such a classifier survives strict, label-free application to an unseen region.
...
standardisation or covariance alignment such as CORAL [@Sun2016], and domain adaptation has an
established remote-sensing literature [@Tuia2016; @Persello2012]. Concept shift is not: no
realignment of inputs can repair a reversal in the sign of an association, because detecting one
requires the labels being withheld. Shift decomposition in applied remote sensing is not itself new
[@Huang2026], but we are aware of no prior application of covariance alignment to fire
...
and dissimilar pairs collapsing; its label is a principal-component composite of hazard *indicators*
...
response variable**: theirs is human-driven ignition, ours burned area, which have different
