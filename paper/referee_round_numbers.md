...
```
drive_new/diagnostics/marginal_aoa_completion/4b2a1c86c0c197c2a331c133d1120f9531ce385441d86af0d8c6154024417492/comparison/marginal_diagnostics_with_transfer.csv
```
...
|---|---|---|---|---|---|---|
| Manavgat to Bejís | 0.2646 | 0.9156 | 0.2731 | 0.4580 | 0.3258 | 0.0488 |
| Manavgat to Muğla | 0.8752 | 0.9640 | 0.1401 | 0.2436 | 0.4702 | 0.0626 |
| Manavgat to Evia | 0.7444 | 0.9425 | 0.1676 | 0.2968 | 0.6126 | 0.3427 |
| Bejís to Manavgat | 0.2207 | 0.7486 | 0.3651 | 0.6871 | 0.4435 | 0.0344 |
| Bejís to Muğla | 0.1998 | 0.7638 | 0.3199 | 0.4933 | 0.6185 | 0.0925 |
| Bejís to Evia | 0.1705 | 0.6534 | 0.3378 | 0.5257 | 0.3828 | 0.2258 |
| Muğla to Manavgat | 0.5305 | 0.9702 | 0.2322 | 0.5502 | 0.4010 | 0.0287 |
| Muğla to Bejís | 0.0050 | 0.9076 | 0.4663 | 0.8550 | 0.5832 | 0.0883 |
| Muğla to Evia | 0.5810 | 0.9510 | 0.2013 | 0.4326 | 0.6534 | 0.3788 |
| Evia to Manavgat | 0.4067 | 0.8995 | 0.3495 | 0.7555 | 0.6858 | 0.0938 |
...
6.9e-17 (PR-AUC). The two files are consistent.
...
|---|---|---|---|---|
| Manavgat to Bejís | 0.072 | 0.049 [0.043, 0.055] | 0.067 [0.058, 0.076] | 0.070 [0.061, 0.079] |
| Manavgat to Muğla | 0.070 | 0.063 [0.058, 0.068] | 0.061 [0.056, 0.067] | 0.064 [0.058, 0.070] |
| Manavgat to Evia | 0.287 | 0.343 [0.318, 0.369] | 0.312 [0.288, 0.338] | 0.324 [0.299, 0.352] |
| Manavgat to Montiferru | 0.212 | 0.243 [0.202, 0.292] | 0.254 [0.212, 0.299] | 0.250 [0.210, 0.296] |
| Bejís to Manavgat | 0.038 | 0.034 [0.029, 0.042] | 0.039 [0.032, 0.047] | 0.043 [0.037, 0.050] |
...
| Muğla to Manavgat | 0.038 | 0.029 [0.025, 0.033] | 0.043 [0.037, 0.051] | 0.044 [0.037, 0.052] |
...
| Evia to Manavgat | 0.038 | 0.094 [0.076, 0.117] | 0.036 [0.031, 0.042] | 0.037 [0.032, 0.043] |
...
| Montiferru to Manavgat | 0.038 | 0.042 [0.036, 0.049] | 0.054 [0.044, 0.067] | 0.053 [0.045, 0.063] |
...
| Direction | No-skill | Raw | z-score | CORAL |
|---|---|---|---|---|
| Manavgat to Bejís | 0.072 | 0.049 [0.044, 0.056] | 0.057 [0.051, 0.065] | 0.057 [0.051, 0.065] |
| Manavgat to Muğla | 0.070 | 0.075 [0.069, 0.082] | 0.065 [0.060, 0.071] | 0.068 [0.063, 0.074] |
| Manavgat to Evia | 0.287 | 0.353 [0.327, 0.381] | 0.308 [0.285, 0.333] | 0.330 [0.305, 0.358] |
| Manavgat to Montiferru | 0.212 | 0.264 [0.221, 0.314] | 0.283 [0.236, 0.336] | 0.252 [0.210, 0.296] |
| Bejís to Manavgat | 0.038 | 0.033 [0.028, 0.040] | 0.034 [0.029, 0.041] | 0.035 [0.029, 0.043] |
...
| Muğla to Manavgat | 0.038 | 0.038 [0.032, 0.044] | 0.048 [0.040, 0.057] | 0.048 [0.041, 0.056] |
...
| Evia to Manavgat | 0.038 | 0.077 [0.064, 0.094] | 0.043 [0.037, 0.050] | 0.044 [0.037, 0.051] |
...
| Montiferru to Manavgat | 0.038 | 0.037 [0.032, 0.044] | 0.063 [0.053, 0.076] | 0.066 [0.057, 0.078] |
...
prevalence in 11 of 20 directions, entirely below in 5, and straddling it in 4.
...
|---|---|---|---|---|---|---|
| Manavgat | 20555 | 20511 | 784 | 784 | 0.038 | 0.0382 |
...
|---|---|---|
| Mean ROC-AUC | 0.5371 | 0.5414 |
| Minimum | 0.3322 (Manavgat to Bejís) | 0.3258 (Manavgat to Bejís) |
| Maximum | 0.6758 (Evia to Manavgat) | 0.6858 (Evia to Manavgat) |
| Directions below 0.5 at the point estimate | 4 of 20 | 6 of 20 |
| Directions with the CI entirely below 0.5 | 4 of 20 | 6 of 20 |
| Directions with the CI entirely above 0.5 | 12 of 20 | 12 of 20 |
| Directions with the CI crossing 0.5 | 4 of 20 | 2 of 20 |

**Mean thermal minus baseline delta: +0.00424**, which rounds to +0.004 as reported in
...
estimates. It agrees with the difference of the two column means (0.54137 minus
0.53712 = 0.00425).
...
- Manavgat to Bejís: 0.3322 [0.311, 0.355]
- Bejís to Manavgat: 0.4209 [0.385, 0.457]
...
- Manavgat to Bejís: 0.3258 [0.304, 0.348]
- Manavgat to Muğla: 0.4702 [0.454, 0.486]
- Bejís to Manavgat: 0.4435 [0.409, 0.477]
- Bejís to Evia: 0.3828 [0.364, 0.403]
- Muğla to Manavgat: 0.4010 [0.376, 0.425]
- Evia to Bejís: 0.4480 [0.427, 0.469]

Paired delta support, from the `delta_interpretation` column:
positive in 10 directions,
negative in 7,
uncertain in 3.
...
| Block | Path |
|---|---|
| Section 1 | `drive_new/diagnostics/marginal_aoa_completion/4b2a1c86c0c197c2a331c133d1120f9531ce385441d86af0d8c6154024417492/comparison/marginal_diagnostics_with_transfer.csv` |
