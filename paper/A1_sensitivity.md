...
Section 4.10 states the result and its withdrawal; the design, the two structural asymmetries that
...
Section 4.8 states both results; the four feature-set configurations, the per-region deltas and the
