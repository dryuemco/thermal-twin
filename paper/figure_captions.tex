...
%
% Figure numbering note: the former three-panel Fig. 6 was split into three
% separate figures (6a, 6b, 6c) because panel (a) needs the full column width
% for its 12 direction labels. Fig. 7 keeps its number. If the journal prefers
% consecutive integers, 6a/6b/6c become Fig. 6/7/8 and the contrast-pairs
% figure becomes Fig. 9; the \label keys below are stable either way.
%
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=190mm]{figures/fig3_4_within_robustness.pdf}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=190mm]{figures/fig5_transfer_matrix.pdf}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=190mm]{figures/fig6a_adaptation.pdf}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=190mm]{figures/fig6b_loro.pdf}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=190mm]{figures/fig6c_feature_drop.pdf}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=190mm]{figures/fig7_contrast_pairs.pdf}
