...
Section~\ref{sec:5.8} states the four limitations that bind the conclusions; all eleven are here. The rest of this appendix, which specifies the protocol, is released with the supplementary appendices rather than printed here.
