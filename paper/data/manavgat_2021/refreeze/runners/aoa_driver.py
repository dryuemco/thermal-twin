# Copied from rerun_labelfix/_round3/runners/aoa_driver.py for stage D (S6).
...
strict = False  # refreeze: both arms. The repo pins Manavgat to 054a1961, but both refreeze step8a files differ from it (80th column; the official one also by the label). Correctness is checked by G1 (control vs drive_new) instead.
class ReuseOnly:
