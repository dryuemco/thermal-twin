...
const check = [
  ...
  ['manavgat_2021', 'mugla_2021', 2], // ROUND3 ASSERT CHANGE: frozen 4 -> corrected 2 (same computation, corrected step9g/synthesis signed AUCs)
  ['manavgat_2021', 'bejis_2022', 2], // ROUND3 ASSERT CHANGE: frozen 4 -> corrected 2 (same computation, corrected step9g/synthesis signed AUCs)
];
