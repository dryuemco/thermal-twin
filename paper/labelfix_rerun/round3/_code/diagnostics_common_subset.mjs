...
if (setA.length !== 12 || setB.length !== 18) throw /* ROUND3 ASSERT CHANGE: setB 16 -> 18 (Manavgat~Montiferru now has 2 jointly supported features; same filter) */ new Error(`unexpected subset sizes ${setA.length}/${setB.length}`);
