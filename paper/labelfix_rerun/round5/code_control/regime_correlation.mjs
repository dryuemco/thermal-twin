...
const aoa = parseCSV(readFileSync(`${ROOT}/drive_new/diagnostics/marginal_aoa_completion/${process.env.AOA_ID || '4b2a1c86c0c197c2a331c133d1120f9531ce385441d86af0d8c6154024417492'}/comparison/marginal_diagnostics_with_transfer.csv`, 'utf8'));
let maxAucDiff = 0;
for (const r of aoa) {
