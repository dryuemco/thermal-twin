...
if (setA.length !== 12 || setB.length !== 16) throw /* ROUND5 control arm: frozen assert value restored (round3 changed 16 -> 18) (Manavgat~Montiferru now has 2 jointly supported features; same filter) */ new Error(`unexpected subset sizes ${setA.length}/${setB.length}`);
