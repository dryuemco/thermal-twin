...
Generated at: 2026-09-19T09:35:50.850298+00:00
Canonical AOI set id: `bejis_2022__manavgat_2021__mugla_2021`
...
- Display order: bejis_2022, manavgat_2021, mugla_2021
- Canonical order: bejis_2022, manavgat_2021, mugla_2021
...
- Strongest raw (unadapted) thermal ROC-AUC direction: bejis_2022 -> mugla_2021 (ROC-AUC = 0.6185).
- Weakest raw (unadapted) thermal ROC-AUC direction: bejis_2022 -> manavgat_2021 (ROC-AUC = 0.3142).
- Directions where raw thermal discrimination was not bootstrap-supported above chance: bejis_2022 -> manavgat_2021, manavgat_2021 -> bejis_2022, manavgat_2021 -> mugla_2021, mugla_2021 -> manavgat_2021.
- Pairs with bidirectional raw thermal ROC-AUC support: bejis_2022/mugla_2021.
- 8 row(s) have an adapted-minus-raw ROC-AUC effect that is not bootstrap-resolved (CI crosses zero).
- 10 row(s) have bootstrap-supported ROC-AUC improvement over raw transfer.
- 6 row(s) have bootstrap-supported ROC-AUC degradation relative to raw transfer.
- 13 adapted-transfer row(s) have ROC-AUC bootstrap-supported below chance (0.5).
- 8 adapted-transfer row(s) have ROC-AUC bootstrap-supported above chance (0.5).
- 3 adapted-transfer row(s) have ROC-AUC for which chance level (0.5) is not excluded.
...
- Pairs with at least one bootstrap-supported feature-level direction reversal: bejis_2022/manavgat_2021, manavgat_2021/mugla_2021.
- 24 transfer-matrix row(s) show a bootstrap-supported remaining residual gap after adaptation.
- Range of raw thermal ROC-AUC across all resolved directions: 0.3043.
